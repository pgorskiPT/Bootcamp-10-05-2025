...
print(f"Reduce:", sum_all)  # Reduce: 1360

l_1 = [i for i in lista if i % 2 == 0]
print(l_1)  # [2, 78, 100, 200, 300]
l_2 = [i * 2 for i in l_1]
print(l_2)  # [4, 156, 200, 400, 600]
...
print(fib)
# hits - uzyskał wynik bez ponownego obliczania
